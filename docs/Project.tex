...
\subsubsection{Semantical validation of a sentence}
Semantical validation of a sentence is a challenging task since it requires understanding the meaning of a sentence.
